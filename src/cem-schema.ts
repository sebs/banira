/**
 * The official Custom Elements Manifest JSON Schema (draft-07), vendored from
 * the `custom-elements-manifest` project so banira can validate the manifests it
 * emits against the canonical spec shape without a network fetch at runtime.
 *
 * Source: https://github.com/webcomponents/custom-elements-manifest/blob/master/schema.json
 *
 * Kept as a TypeScript module (rather than a loose `.json`) so the plain `tsc`
 * build ships it into `dist/` automatically — there is no asset-copy step.
 *
 * @see {@link validateManifestSchema}
 */
export const CEM_SCHEMA = {
    ...
    definitions: {
        Attribute: {
            properties: {
                ...
                description: { description: 'A markdown description.', type: 'string' },
                fieldName: {
                    description: 'The name of the field this attribute is associated with, if any.',
                    type: 'string',
                },
                inheritedFrom: { $ref: '#/definitions/Reference' },
                name: { type: 'string' },
                summary: {
        ...
        ClassDeclaration: {
            properties: {
                ...
                description: { description: 'A markdown description of the class.', type: 'string' },
                kind: { enum: ['class'], type: 'string' },
                members: {
                    items: {
                        anyOf: [{ $ref: '#/definitions/ClassField' }, { $ref: '#/definitions/ClassMethod' }],
                    },
                    type: 'array',
                },
                mixins: {
                ...
                name: { type: 'string' },
                source: { $ref: '#/definitions/SourceReference' },
                summary: {
                    description: 'A markdown summary suitable for display in a listing.',
                    type: 'string',
                },
        ...
        ClassField: {
            properties: {
                ...
                description: { description: 'A markdown description of the field.', type: 'string' },
                inheritedFrom: { $ref: '#/definitions/Reference' },
                kind: { enum: ['field'], type: 'string' },
                name: { type: 'string' },
                privacy: { $ref: '#/definitions/Privacy' },
                readonly: { description: 'Whether the property is read-only.', type: 'boolean' },
                source: { $ref: '#/definitions/SourceReference' },
                static: { type: 'boolean' },
                summary: {
                    description: 'A markdown summary suitable for display in a listing.',
        ...
        CssCustomProperty: {
            properties: {
                ...
                description: { description: 'A markdown description.', type: 'string' },
                name: { description: 'The name of the property, including leading `--`.', type: 'string' },
                summary: {
                    description: 'A markdown summary suitable for display in a listing.',
                    type: 'string',
                },
        ...
        CustomElementDeclaration: {
            ...
            properties: {
                ...
                cssParts: { items: { $ref: '#/definitions/CssPart' }, type: 'array' },
                cssProperties: { items: { $ref: '#/definitions/CssCustomProperty' }, type: 'array' },
                cssStates: { items: { $ref: '#/definitions/CssCustomState' }, type: 'array' },
                customElement: {
                    description: 'Distinguishes a regular JavaScript class from a\ncustom element class',
                    enum: [true],
                    type: 'boolean',
                },
                demos: { items: { $ref: '#/definitions/Demo' }, type: 'array' },
                deprecated: {
                    description:
                        "Whether the class or mixin is deprecated.\nIf the value is a string, it's the reason for the deprecation.",
                    type: ['string', 'boolean'],
            ...
            required: ['customElement', 'kind', 'name'],
            type: 'object',
        },
        CustomElementExport: {
            description:
            ...
            properties: {
                ...
                kind: { enum: ['custom-element-definition'], type: 'string' },
                name: { description: 'The tag name of the custom element.', type: 'string' },
            },
            required: ['declaration', 'kind', 'name'],
            type: 'object',
        },
        ...
        Demo: {
            properties: {
                description: { description: 'A markdown description of the demo.', type: 'string' },
                source: { $ref: '#/definitions/SourceReference' },
                url: {
                    description:
        ...
        FunctionDeclaration: {
            properties: {
                ...
                description: { description: 'A markdown description.', type: 'string' },
                kind: { enum: ['function'], type: 'string' },
                name: { type: 'string' },
                parameters: { items: { $ref: '#/definitions/Parameter' }, type: 'array' },
                return: {
                    properties: {
        ...
        JavaScriptModule: {
            properties: {
                ...
                description: { description: 'A markdown description of the module.', type: 'string' },
                exports: {
                    description:
                ...
                kind: { enum: ['javascript-module'], type: 'string' },
                path: {
                    description:
        ...
        Privacy: { enum: ['private', 'protected', 'public'], type: 'string' },
        Reference: {
            description:
        ...
        VariableDeclaration: {
            properties: {
                ...
                description: { description: 'A markdown description of the field.', type: 'string' },
                kind: { enum: ['variable'], type: 'string' },
                name: { type: 'string' },
                readonly: { description: 'Whether the property is read-only.', type: 'boolean' },
                source: { $ref: '#/definitions/SourceReference' },
                summary: {
    ...
    properties: {
        ...
        modules: {
            ...
            items: { $ref: '#/definitions/JavaScriptModule' },
            type: 'array',
        },
        readme: {
            description:
        ...
        schemaVersion: { description: 'The version of the schema used in this file.', type: 'string' },
    },
    required: ['modules', 'schemaVersion'],
    type: 'object',
} as const;
